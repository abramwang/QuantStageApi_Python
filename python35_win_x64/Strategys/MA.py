...
class MA(BaseStrategy.BaseStrategy):
	...
	def OnRecvDayBegin(self, dateStr):
		print("MA OnRecvDayBegin: ", dateStr)
		pass
	def OnRecvMarket(self, market):
		...
		self.CalcMA()
		#print("MA OnRecvMarket: ", market["szDatetime"], self.priceList, self.maList)
		pass
	...
	def OnRecvKLine(self, kLine):
		...
		self.CalcMA()
		#print("MA OnRecvKLine: ", kLine["szDatetime"], self.priceList, self.maList)
		pass
