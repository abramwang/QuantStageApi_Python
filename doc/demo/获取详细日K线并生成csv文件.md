...
用户登录成功后，若需**订阅K线行情**，则需先对之进行**参数赋值**操作。
...
class DataCallBack(QuantCallBack):
    ...
    def __init__(self):
        ...
        #写入表格头
        self.detailewriter.writerow(['行情类型','证券代码','时间','开盘价','最高价','最低价','今收价','昨收价','涨停价','跌停价','成交数量','成交金额','周期类型'])
    ...
    def OnRtnKLine(self, pKline):
        ...
        self.detailewriter.writerow(writedata)#写入文件
        pass
...
def main():
    ...
    mapi.ReqSubQuote(3, ["kline"], ["second_10"], ["002003.SZ"], "2018-07-24 8:30:00", "2018-07-24 10:00:00")
    mapi.Run()
